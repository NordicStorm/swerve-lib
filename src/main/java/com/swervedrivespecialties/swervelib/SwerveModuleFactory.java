...
public class SwerveModuleFactory<DriveConfiguration, SteerConfiguration> {
    ...
    private static class ModuleImplementation implements SwerveModule {
        ...
        public double getDrivePosition(){
            return driveController.getSensorPosition();
        }
        @Override
        ...
        @Override
        public void setWithVelocity(double driveVelocity, double steerAngle) {

            // should probably try to refactor to avoid duplicating logic...
        ...
        public CANSparkMax getSparkDriveMotor() {
            return driveController.getSparkMax();
        }

        @Override
        public TalonFX getTalonDriveMotor() {
            return driveController.getTalonFX();
        }
    }
